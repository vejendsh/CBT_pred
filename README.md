...
The code in this repository can be used to train a machine learning-based surrogate model that can predict a 60-minute profile of human Core Body Temperature in response to different external thermal conditions.
