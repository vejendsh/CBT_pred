...
CFD data was used to train the surrogate model which was generated using ANSYS Fluent 2024 R1. The generation of CFD data, its preprocessing, training of the surrogate model, and evaluation of its performance are handled in this repository.
